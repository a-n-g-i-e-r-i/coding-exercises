...
/*
The given file, quicksort-integer-array.txt contains all of the 100,000 integers between 1 and 100,000 (inclusive)
in some order, with no integer repeated.

Compute the total number of comparisons used by QuickSort to sort the given input file,
quicksort-integer-array.txt, where the ith row of the file indicates the ith entry of an array.
...
public class QuickSort {
    ...
    public QuickSort(Long count, String selection) {
        this.count = count;
        this.selection = selection;
    }

    public static void main(String args[]) throws FileNotFoundException {
        QuickSort quickSortMedian = new QuickSort((long) 0, "median");
        quickSortMedian.run();
        // 162085
        QuickSort quickSortFirst = new QuickSort((long) 0, "first");
        quickSortFirst.run();
        // 164123
        QuickSort quickSortLast = new QuickSort((long) 0, "last");
        quickSortLast.run();
        // 138382
    }
    ...
    List<Integer> rowsToArrayList() throws FileNotFoundException {
        Scanner scanner = new Scanner(new File("quicksort-integer-array.txt"));
